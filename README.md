...
- Скачайте код
- Создайте файл .env
- Заполните файл .env по аналогии с .env_example:
  REDIS_URL - не стоит менять при стандартном запуске
  SMS_LOGIN - логин smsc.ru
  SMS_PASSWORD - пароль smsc.ru
  PHONE - номер телефона для отправки sms
